...
public class ContainerReplace extends Container {
	protected TileEntityReplace tileEntity;

	public ContainerReplace(TileEntityReplace tileEntity,
		...
		int height = 18;
		int id = 0;						        	// id, x, y
		addSlotToContainer(new Slot(tileEntity, id, 16 + 0 * width, 36));
		addSlotToContainer(new Slot(tileEntity, 1, 16 + 1 * width + 38, 36));
